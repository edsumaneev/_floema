...
$(function () {
  var selectSize,
    ...
    pageSizes = {
      "20x20": {
        47: "Digital Paper Type DP II",
        53: "Digital Pearl Paper"
      },
      "19x25": {
        53: "Digital Paper Type DP II",
        57: "Digital Pearl Paper"
      },
      "20x30": {
        57: "Digital Paper Type DP II",
        65: "Digital Pearl Paper"
      },
      "25x25": {
        63: "Digital Paper Type DP II",
        69: "Digital Pearl Paper"
      },
      "30x30": {
        76: "Digital Paper Type DP II",
        85: "Digital Pearl Paper"
      },
      "35x35": {
        105: "Digital Paper Type DP II",
        117: "Digital Pearl Paper"
      },
      "30x40": {
        105: "Digital Paper Type DP II",
        117: "Digital Pearl Paper"
      ...
      "40x40": {
        212: "Digital Paper Type DP II",
        238: "Digital Pearl Paper"
      },
    },
    covers = {
      "20x20": {
        53: "Обрезная фото обложка",
        204: "Фото обложка",
        355: "Обложка кож.зам",
        587: "Обложка холст"
      },
      "19x25": {
        57: "Обрезная фото обложка",
        228: "Фото обложка",
        373: "Обложка кож.зам",
        667: "Обложка холст"
      },
  ...
  function insertPages() {
    ...
    for (size in pageSizes) {
      for (price in pageSizes[size]) {
        html += '<option data-size="' + size + '" data-price="' + price + '">' + size + ' - ' + pageSizes[size][price] + ' ' + price + ' p.</option>';
      }
    }
  ...
  function insertCover() {
    ...
    for (price in covers[selectSize]) {
      html += '<option data-price="' + price + '">' + covers[selectSize][price] + ' ' + price + ' р.</option>';
    }
    $('#cover').html(html);
  };
  ...
  function changeTable() {
    $('.page-size').text(selectPrice + ' p.');
    $('.qty').text(qty);
    $('.cover').text(selectCover + ' p.');
    $('.endpaper').text(endPaper + ' p.');
    $('.sum').text(sum + ' p.');
  }
